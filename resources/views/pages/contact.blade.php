                        ...
                        <div class="space-y-6">
                            <div class="flex items-start">
                                <div class="bg-grocery-light p-3 rounded-full mr-4">
                                    <x-heroicon-o-phone class="h-5 w-5 text-grocery-primary" />
                                </div>
                                <div>
                            ...
                            <div class="flex items-start">
                                <div class="bg-grocery-light p-3 rounded-full mr-4">
                                    <x-heroicon-o-envelope class="h-5 w-5 text-grocery-primary" />
                                </div>
                                <div>
                            ...
                            <div class="flex items-start">
                                <div class="bg-grocery-light p-3 rounded-full mr-4">
                                    <x-heroicon-o-map-pin class="h-5 w-5 text-grocery-primary" />
                                </div>
                                <div>
